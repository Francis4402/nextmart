                    ...
                    <div className='my-5'>
                        {featureFields.map((featureField, index) => (
                            <div key={featureField.id}>
                                <FormField control={form.control} name={`keyFeatures.${index}.value`} render={({field}) => (
                                    <FormItem>
                ...
                <div>
                    ...
                    {specFields.map((specField, index) => (
                        <div key={specField.id} className='grid grid-cols-1 gap-4 md:grid-cols-2 my-5'>
                            <FormField control={form.control} name={`specification.${index}.key`} render={({field}) => (
                                <FormItem>
                            ...
                            <FormField control={form.control} name={`specification.${index}.value`} render={({field}) => (
                                <FormItem>
